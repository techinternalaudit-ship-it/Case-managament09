...
const REFERENCE_DATA = [
  ...
  ["Type of Complainant", "Merchant / Employee / Customer / HR / MHD / Anonymous"],
  ["Sale/Not - Sale", "Sale / Not Sale"],
  ["Substantiated", "Substantiated / Un-substantiated / Partially Substantiated / NA"],
  ["Report Status", "NA - Unsubstantiated / Report ready for DC / Report sent to DC / Report sent to CBO / Report sent to CHRO / NA"],
  ["Process/Employee Rec Approved by DC", "Yes / No / NA"],
  ["Employee Related Action", "Termination / Warning Letter / ATL / Caution Letter / Others / No action required / Verbal Warning"],
  ["Employee Related Action Status", "Action Implemented / Action In-progress / Difficult in Implementation / Yet to communicate / Not Required"],
  ["Escalation Channel", "Employee Escalations / HR Escalations / Executive Escalations / Business escalation / Internal Audit / Vigilance Initiated / Social Media Escalation / Whistleblower"],
