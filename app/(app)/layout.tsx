    ...
    <div className="min-h-screen flex bg-canvas dark:bg-[#0b0f1a]">
      ...
      <aside className="w-[var(--sidebar-w)] shrink-0 bg-white/80 dark:bg-white/[0.02] backdrop-blur-xl border-r border-ink-200/50 dark:border-white/[0.06] flex flex-col sticky top-0 h-screen">
        ...
        <div className="border-t border-ink-100/60 dark:border-white/[0.04] p-4">
          <Link href="/profile" className="flex items-center gap-3 mb-3 rounded-xl -mx-1 px-1 py-1 hover:bg-ink-100 dark:hover:bg-white/[0.06] transition-colors group">
            ...
            <Icon name="settings" className="h-3.5 w-3.5 text-ink-300 dark:text-gray-600 group-hover:text-ink-500 dark:group-hover:text-gray-400 transition-colors shrink-0" />
          </Link>
